    ...
    <Layout>
        ...
        <div className='container text-center py-5'>
          <h1 className='ff-caveat mb-4'>Budget Bliss:<br />
            <span class="cz_d">
              <svg className='cz_gf b1_f2' xmlns='http://www.w3.org/2000/svg' width='504' height='106' viewBox='0 0 504 106' style={{transform:'scaleX(0.9) scaleY(0.93) rotate(2deg)'}}>
          ...
          <UserAuthSections authorized={true}>
            <a className='btn secondaryBtn w-auto mt-5' href='/transactions'>Manage Your Transactions</a>
          </UserAuthSections>
        </div>
